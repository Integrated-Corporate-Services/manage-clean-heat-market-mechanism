...
namespace Desnz.Chmm.McsSynchronisation.Api.Migrations
{
    ...
    [Migration("20250128111148_ChangedIntersectTable")]
    partial class ChangedIntersectTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Desnz.Chmm.McsSynchronisation.Api.Entities.InstallationRequest", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("IsNewBuildIds")
                        .HasColumnType("integer[]");
                    ...
                    b.PrimitiveCollection<int[]>("TechnologyTypeIds")
                        .HasColumnType("integer[]");
