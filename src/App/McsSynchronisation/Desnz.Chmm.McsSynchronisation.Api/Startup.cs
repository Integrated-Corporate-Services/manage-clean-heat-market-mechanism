...
using Desnz.Chmm.McsSynchronisation.Api.Extensions;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.Configure<McsApiConfig>(_configuration.GetSection(ConfigurationValueConstants.McsApi));
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "CHMM Mcs Synchronisation", Version = "v1" });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwagger(c =>
        {
            c.RouteTemplate = "api/mcssynchronisation/swagger/{documentName}/swagger.json";
        });

        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("v1/swagger.json", "CHMM MCS Synchronisation V1");
            c.RoutePrefix = "api/mcssynchronisation/swagger";
        });
