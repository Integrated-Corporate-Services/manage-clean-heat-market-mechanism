...
using Desnz.Chmm.Configuration.Api.Extensions;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "CHMM Configuration", Version = "v1" });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwagger(c =>
        {
            c.RouteTemplate = "api/Configuration/swagger/{documentName}/swagger.json";
        });

        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("v1/swagger.json", "CHMM Configuration API V1");
            c.RoutePrefix = "api/Configuration/swagger";
        });
