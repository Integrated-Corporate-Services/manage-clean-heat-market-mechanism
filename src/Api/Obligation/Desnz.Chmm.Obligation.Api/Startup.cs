...
using Desnz.Chmm.Obligation.Api.Extensions;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "CHMM Obligation", Version = "v1" });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwagger(c =>
        {
            c.RouteTemplate = "api/obligation/swagger/{documentName}/swagger.json";
        });

        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("v1/swagger.json", "CHMM Obligation API V1");
            c.RoutePrefix = "api/obligation/swagger";
        });
