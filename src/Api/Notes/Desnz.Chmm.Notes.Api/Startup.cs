...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "CHMM Notes", Version = "v1" });
        ...
        services.AddTransient<INotesContext, NotesContext>();
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwagger(c =>
        {
            c.RouteTemplate = "api/Notes/swagger/{documentName}/swagger.json";
        });

        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("v1/swagger.json", "CHMM Notes API V1");
            c.RoutePrefix = "api/Notes/swagger";
        });
