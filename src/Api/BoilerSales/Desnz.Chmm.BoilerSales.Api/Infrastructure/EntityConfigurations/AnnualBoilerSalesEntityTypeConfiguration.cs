...
public class AnnualBoilerSalesEntityTypeConfiguration : IEntityTypeConfiguration<AnnualBoilerSales>
{
    void IEntityTypeConfiguration<AnnualBoilerSales>.Configure(EntityTypeBuilder<AnnualBoilerSales> entity)
    {
        entity.HasKey(u => u.Id);

        entity.HasIndex(u => new { u.OrganisationId, u.SchemeYearId });
        entity.HasIndex(u => new { u.SchemeYearId });
