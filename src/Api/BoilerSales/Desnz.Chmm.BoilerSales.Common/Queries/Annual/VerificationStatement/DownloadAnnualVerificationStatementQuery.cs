...
public class DownloadAnnualVerificationStatementQuery : IRequest<ActionResult<Stream>>
{
    /// <summary>
    /// Download an annual verification statement file from the given manufacturer
    /// </summary>
    ...
    public DownloadAnnualVerificationStatementQuery(Guid organisationId, Guid schemeYearId, string fileName, bool? isEditing = null)
    {
