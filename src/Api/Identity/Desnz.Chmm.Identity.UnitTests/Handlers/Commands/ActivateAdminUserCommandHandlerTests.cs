...
public class ActivateAdminUserCommandHandlerTests
{
    private Mock<IUsersRepository> _mockUsersRepository;
    private Mock<ILogger<ActivateAdminUserCommandHandler>> _mockLogger;
    ...
    public ActivateAdminUserCommandHandlerTests()
    {
        _mockUsersRepository = new Mock<IUsersRepository>(MockBehavior.Strict);
        _mockLogger = new Mock<ILogger<ActivateAdminUserCommandHandler>>();
    ...
    {
        //Arrange
        var handler = new ActivateAdminUserCommandHandler(_mockLogger.Object, _mockUsersRepository.Object, _mockIdentityNotificationService.Object);
        var command = new ActivateAdminUserCommand() { Id = Guid.NewGuid() };
    ...
    internal async Task TestPostUser_NoContentAsync()
    {
        ...
        _mockIdentityNotificationService.Setup(x => x.NotifyUserActivated(user));
