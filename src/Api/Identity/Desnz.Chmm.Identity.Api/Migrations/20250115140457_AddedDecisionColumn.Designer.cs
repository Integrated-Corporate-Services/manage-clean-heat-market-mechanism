...
namespace Desnz.Chmm.Identity.Api.Migrations
{
    ...
    [Migration("20250115140457_AddedDecisionColumn")]
    partial class AddedDecisionColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.LicenceHolder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("McsManufacturerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "McsManufacturerId" }, "IX_UNIQUE_LICENCE_HOLDER")
                        .IsUnique();

                    b.ToTable("LicenceHolders");
                });

            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.LicenceHolderLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LicenceHolderId");

                    b.HasIndex("OrganisationId");

                    b.ToTable("LicenceHolderLinks");
                });
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.Organisation", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("HeatPumpBrands")
                        .HasColumnType("varchar(100)[]");
                    ...
                    b.Property<bool>("IsNonSchemeParticipant")
                        .HasColumnType("boolean");

                    b.Property<string>("LegalAddressType")
                        .IsRequired()
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.OrganisationDecisionComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OrganisationDecisionComments");
                });

            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.OrganisationDecisionFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OrganisationDecisionFiles");
                });
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.LicenceHolderLink", b =>
                {
                    b.HasOne("Desnz.Chmm.Identity.Api.Entities.LicenceHolder", "LicenceHolder")
                        .WithMany("LicenceHolderLinks")
                        .HasForeignKey("LicenceHolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.OrganisationDecisionFile", b =>
                {
                    b.HasOne("Desnz.Chmm.Identity.Api.Entities.Organisation", "Organisation")
                        .WithMany("OrganisationDecisionFiles")
                        .HasForeignKey("OrganisationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.LicenceHolder", b =>
                {
                    b.Navigation("LicenceHolderLinks");
                });
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Api.Entities.Organisation", b =>
                {
                    ...
                    b.Navigation("OrganisationDecisionFiles");
