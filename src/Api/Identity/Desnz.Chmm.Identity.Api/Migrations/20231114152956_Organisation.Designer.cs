...
namespace Desnz.Chmm.Identity.Api.Migrations
{
    ...
    [Migration("20231114152956_Organisation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Common.Entities.ChmmUser", b =>
                {
                    ...
                    b.Property<Guid?>("UserOrganisationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Common.Entities.Organisation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Common.Entities.OrganisationAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AddressOrganisationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AddressOrganisationId");
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Common.Entities.ChmmUser", b =>
                {
                    b.HasOne("Desnz.Chmm.Identity.Common.Entities.Organisation", "Organisation")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Desnz.Chmm.Identity.Common.Entities.OrganisationAddress", b =>
                {
                    b.HasOne("Desnz.Chmm.Identity.Common.Entities.Organisation", "Organisation")
                        .WithMany("Addresses")
                        .HasForeignKey("AddressOrganisationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
