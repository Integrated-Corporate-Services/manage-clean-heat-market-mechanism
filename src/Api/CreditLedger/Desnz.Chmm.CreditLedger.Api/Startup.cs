...
using Desnz.Chmm.CreditLedger.Api.Extensions;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "CHMM Credit Ledger", Version = "v1" });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwagger(c =>
        {
            c.RouteTemplate = "api/creditledger/swagger/{documentName}/swagger.json";
        });

        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("v1/swagger.json", "CHMM Credit Ledger v1");
            c.RoutePrefix = "api/creditledger/swagger";
        });
