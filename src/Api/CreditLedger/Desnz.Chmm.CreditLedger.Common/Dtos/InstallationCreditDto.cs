...
/// </summary>
public class InstallationCreditDto
{
    #region Constructors
    ...
    /// </summary>
    protected InstallationCreditDto() { }

    public InstallationCreditDto(Guid licenceHolderId, int heatPumpInstallationId, Guid schemeYearId, DateOnly dateCreditGenerated, decimal value, bool isHybrid)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals(obj as InstallationCreditDto);
    }

    public bool Equals(InstallationCreditDto other)
    {
