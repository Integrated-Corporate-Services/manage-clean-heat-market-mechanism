@APITest
Feature: Verify CHMM GET uploaded approval file to an organisation API works as expected
    ...
    Scenario Outline: 1. Verify that GET approval files returns 200
        ...
        When the user send a GET request to "/identity/organisations/organisationId/approval-files" with authentication token
