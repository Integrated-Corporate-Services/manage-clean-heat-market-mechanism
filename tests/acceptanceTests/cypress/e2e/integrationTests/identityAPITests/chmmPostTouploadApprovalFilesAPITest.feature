@APITest
Feature: Verify CHMM POST to upload approval file to an organisation API works as expected
    ...
    Scenario Outline: 1.  Verify that POST approval files by a manufacturer user returns 200
