@APITest
Feature: Verify CHMM Get to Download Annual boiler sales Verification Statement for an organisation API works as expected
    CHMM Get to download annual boiler sales Verification Statement for an organisation API test

    
    Scenario Outline: 1. Verify that GET to download annual boiler sales verification statement for an organisation by an admin user returns 200
        ...
        When the user send a GET request to "/boilersales/organisation/organisationId/year/<schemeYearId>/annual/verification-statement/download?fileName=<fileNames>" to download files with authentication token
        ...
        Examples:
            ...
            # NOTE uncomment this once the bug with file download is fixed CHMMBETA-661
    ...
    Scenario Outline: 2. Verify that GET to download annual boiler sales verification statement for an organisation by a manufacturer user returns 200
    ...
    Scenario Outline: 3. Verify that GET to download annual boiler sales verification statement for an organisation by an admin/manufacturer user with invalid organisationId/schemeYearId returns 404
    ...
    Scenario Outline: 4. Verify that GET to download annual boiler sales verification statement for an organisation by an admin user with non existing file returns 400
        ...
        When the user send a GET request to "/boilersales/organisation/organisationId/year/<schemeYearId>/annual/verification-statement/download?fileName=<downloadFileNames>" to download files with authentication token
    ...
    Scenario Outline: 5. Verify that GET to download annual boiler sales verification statement for an organisation by a manufacturer user with non existing file returns 400
    ...
    Scenario Outline: 6. Verify that GET to download annual boiler sales verification statement for an organisation without authentication token returns 401

        Given the user has authentication token for "<authEmailId>" email id

        When the user send a GET request to "/boilersales/organisation/<organisationId>/year/<schemeYearId>/annual/verification-statement/download?fileName=<fileNames>" to download files without authentication token
