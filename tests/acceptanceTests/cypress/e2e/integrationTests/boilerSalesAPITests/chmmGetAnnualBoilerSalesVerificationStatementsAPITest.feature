@APITest
Feature: Verify CHMM Get Annual boiler sales Verification Statement for an organisation API works as expected
    CHMM Get annual boiler sales Verification Statement for an organisation API test


    Scenario Outline: 1. Verify that GET annual boiler sales verification statement for an organisation by an admin user returns 200
        ...
        When the user send a GET request to "/boilersales/organisation/organisationId/year/<schemeYearId>/annual/verification-statement" to fetch files with authentication token
    ...
    Scenario Outline: 2. Verify that GET annual boiler sales verification statement for an organisation by a manufacturer user returns 200
    ...
    Scenario Outline: 3. Verify that GET annual boiler sales verification statement for an organisation by an admin/manufacturer user with invalid organisation id/schemeYearId returns 404
