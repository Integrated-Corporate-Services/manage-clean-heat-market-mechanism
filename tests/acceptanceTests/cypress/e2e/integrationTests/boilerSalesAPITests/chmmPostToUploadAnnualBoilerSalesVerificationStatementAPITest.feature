@APITest
Feature: Verify CHMM Post to upload Annual boiler sales Verification Statement for an organisation API works as expected
    CHMM Post to upload annual boiler sales Verification Statement for an organisation API test


    Scenario Outline: 1. Verify that POST to upload annual boiler sales verification statement for an organisation by an admin user returns 200
        ...
        When the user send a POST request to "/boilersales/organisation/organisationId/year/<schemeYearId>/annual/verification-statement" to upload "<fileNames>" file for "verificationStatement" with authentication token
    ...
    Scenario Outline: 2. Verify that POST to upload annual boiler sales verification statement for an organisation by a manufacturer user returns 200
    ...
    Scenario Outline: 3. Verify that POST annual boiler sales verification statement for an organisation by an admin user with un-supported file types returns 400
    ...
    Scenario Outline: 4. Verify that POST annual boiler sales verification statement for an organisation by a manufacturer user with un-supported file types returns 400
    ...
    Scenario Outline: 5. Verify that POST annual boiler sales verification statement for an organisation by an admin user with large and corrupt files returns 413
    ...
    Scenario Outline: 6. Verify that POST annual boiler sales verification statement for an organisation by a manufacturer user with large and corrupt files returns 413
    ...
    Scenario Outline: 7. Verify that POST annual boiler sales verification statement for an organisation by an admin/manufacturer user with invalid organisationId/schemeYearQuarterId returns 404
    ...
    Scenario Outline: 8. Verify that POST annual boiler sales verification statement for an organisation by an admin user with same schemeYearId/schemeYearQuarterId returns 400
    ...
    Scenario Outline: 9. Verify that POST annual boiler sales verification statement for an organisation by a manufacturer user with same schemeYearId/schemeYearQuarterId returns 400
    ...
    Scenario Outline: 10. Verify that POST annual boiler sales verification statement for an organisation by an admin/manufacturer user without authentication token returns 401

        When the user send a POST request to "/boilersales/organisation/<organisationId>/year/<schemeYearId>/annual/verification-statement" to upload "<fileNames>" file for "verificationStatement" without authentication token
