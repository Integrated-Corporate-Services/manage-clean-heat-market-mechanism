@AccessibilityTest
Feature: Verify accessibility violation on approve CHMM annual boiler sales journey
    ...
    Scenario Outline: 1. Check accessibility violation on are you sure page in annual boiler sales approval journey
